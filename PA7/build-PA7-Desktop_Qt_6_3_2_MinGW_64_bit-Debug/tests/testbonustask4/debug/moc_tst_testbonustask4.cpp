...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_TestBonusTask4_t::offsetsAndSizes) + ofs), len 
static const qt_meta_stringdata_TestBonusTask4_t qt_meta_stringdata_TestBonusTask4 = {
    {
        QT_MOC_LITERAL(0, 14),  // "TestBonusTask4"
        QT_MOC_LITERAL(15, 23),  // "testComputeEntropy_data"
        QT_MOC_LITERAL(39, 0),  // ""
        QT_MOC_LITERAL(40, 18),  // "testComputeEntropy"
        QT_MOC_LITERAL(59, 14),  // "testSolverHint"
        QT_MOC_LITERAL(74, 24)   // "testSolverHintWithUpdate"
    },
    "TestBonusTask4",
    "testComputeEntropy_data",
    "",
    "testComputeEntropy",
    "testSolverHint",
...
const QMetaObject TestBonusTask4::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_meta_stringdata_TestBonusTask4.offsetsAndSizes,
    qt_meta_data_TestBonusTask4,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_TestBonusTask4_t
, QtPrivate::TypeAndForceComplete<TestBonusTask4, std::true_type>
